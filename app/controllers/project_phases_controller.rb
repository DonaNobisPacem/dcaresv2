class ProjectPhasesController < ApplicationController
  ...
  private
    ...
    def project_phase_params
      params.require(:project_phase).permit(:project_id, :phase_name, :description, :expected_outcome, :end_user, :percent_accomplishment, :percent_accomplishment_by, :remarks, :has_components, :has_phases, :bidding_contractor, :bidding_number, :bidding_award, :bidding_proceed, :bidding_duration, :bidding_extension, :bidding_remarks, :financial_source, :financial_budget, :financial_contract_price, :financial_actual_cost, :financial_variation, :financial_remarks, :timeline_target_start, :timeline_target_end, :timeline_actual_start, :timeline_actual_end, :timeline_remarks, :status, :completed_by, :fund_source_ids => [])
    end
end
