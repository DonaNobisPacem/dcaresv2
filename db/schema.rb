...
ActiveRecord::Schema.define(version: 20160413050014) do
  ...
  add_index "funds", ["fundable_type", "fundable_id"], name: "index_funds_on_fundable_type_and_fundable_id", using: :btree
